      ...
      <div className="browse-content">
        <div className="browse-filter-sidebar">
          <div className="browse-filter-group">
            <div className="browse-filter-group-label">Search</div>
            <input
              type="text"
              ...
              style={{
                ...
                border: '1px solid var(--border-section)', borderRadius: 'var(--radius-sm)',
          ...
          <div className="browse-filter-group">
            ...
            <div className="ret-filter-group">
              ...
              <button onClick={() => setFilter('ocp')}
                ...
                <span className="ca-badge ca-badge--ocp" style={{ marginRight: '4px' }}>OCP</span>
                ({ocpCount})
              </button>
              <button onClick={() => setFilter('rhel')}
                className={`ret-filter-group__btn${filter === 'rhel' ? ' active' : ''}`}>
                <span className="ca-badge ca-badge--rhel" style={{ marginRight: '4px' }}>RHEL</span>
                ({rhelCount})
              </button>
            </div>
          </div>

          <div className="ca-stats-grid" style={{ marginTop: '12px' }}>
            ...
            <div className="ret-stat-card">
              <div className="ret-stat-label">Provisions</div>
